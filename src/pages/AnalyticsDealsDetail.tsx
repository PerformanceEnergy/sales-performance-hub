...
export default function AnalyticsDealsDetail() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">New Deals Details</h1>
          <p className="text-muted-foreground">All new deals in selected period</p>
        </div>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Total New Deals: {dealDetails.length}</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
